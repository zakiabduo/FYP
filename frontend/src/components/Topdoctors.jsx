    ...
    <div className="flex flex-col items-center gap-4 my-20 px-4 sm:px-6 md:px-10 lg:px-16 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-slate-400 mt-1.5 max-w-md mx-auto leading-relaxed">
          Simply browse through our top trusted, highly verified healthcare experts and secure your slot instantly.
        </p>
      </div>

      {/* Grid Architecture Responsive Configuration */}
        ...
        {doctors.slice(0, 10).map((item, index) => (
          ...
          >
            ...
            <div className="p-4 flex flex-col flex-grow justify-between gap-3 bg-white">
              ...
              {/* Dynamic Availability Status Indicator with Live Pulse */}
      ...
      {/* Modern Extended Call to Action Trigger Button */}
      <div className="mt-8">
        <button
          onClick={handleMoreClick}
          className="bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-600 hover:text-slate-800 font-semibold px-12 py-3.5 rounded-xl text-sm transition-all shadow-sm active:scale-95 cursor-pointer flex items-center gap-2"
        >
